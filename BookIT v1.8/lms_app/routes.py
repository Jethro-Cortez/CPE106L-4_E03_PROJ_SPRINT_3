...
def user_dashboard():
    ...
    return render_template('user_dashboard.html',
                           ...
                           borrowing_history=borrowing_history,  # Pass borrowing history to the template
...
def return_book(transaction_id):
    ...
    feedbacks = Feedback.query.filter_by(book_id=book.id).all()  # Ensure this is a list
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            if transaction.return_date > transaction.due_date:
                ...
                transaction.fine_amount = days_overdue * 1.0  # $1/day
...
def add_feedback(book_id):
    ...
    if request.method == 'POST':
        message = request.form.get('message')  # Corrected from 'review_text' to 'message'
